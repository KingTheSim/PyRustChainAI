...
class FBANode(Node):
    ...
    def validate_and_prepare_message(self, recipient_id: str, message: str):
        """Elaborate on logic here"""
        pass

    def receive_proposal(self, value: str, from_node_id: str):
